...
// Code splitting OFF — all pages are eagerly imported
import HomePage from "./pages/Home/HomePage";
import DashboardPage from "./pages/Dashboard/DashboardPage";
import CodingPracticePage from "./pages/CodingPractice/CodingPracticePage";
import CreateInterviewPage from "./pages/CreateInterview/CreateInterviewPage";
import InterviewDetailsPage from "./pages/InterviewDetails/InterviewDetailsPage";
import JoinInterviewPage from "./pages/JoinInterview/JoinInterviewPage";
import InterviewRoomPage from "./pages/InterviewRoom/InterviewRoomPage";
import CandidateResultPage from "./pages/CandidateResult/CandidateResultPage";
import InterviewReportPage from "./pages/InterviewReport/InterviewReportPage";
import InterviewTerminatedPage from "./pages/InterviewTerminated/InterviewTerminatedPage";
